...
export function DataSourceModal({ open, onOpenChange, onCheckApi, slicer }: DataSourceModalProps) {
  ...
  const windowsPath = isOrca ? '%APPDATA%\\OrcaSlicer' : '%APPDATA%\\BambuStudio';
        ...
        <div className='min-h-0 flex-1 space-y-5 overflow-y-auto px-5 py-4 text-sm'>
          <section className='border-primary/30 bg-primary/8 rounded-lg border p-4'>
            <div className='flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-center'>
              <div>
                <h3 className='text-foreground font-semibold'>{t('dataSource.desktopTitle')}</h3>
          ...
          <section className='space-y-3'>
            ...
            <div className='grid gap-3 sm:grid-cols-2'>
              <div className='bg-muted/55 rounded-md border border-dashed p-3'>
                ...
                <p className='text-muted-foreground mt-1 font-mono text-xs break-all'>{macPath}</p>
            ...
            <div className='border-border rounded-md border p-3'>
              ...
              <p className='text-muted-foreground mt-2 text-xs'>{t('dataSource.apiOptionalEnv')}</p>
