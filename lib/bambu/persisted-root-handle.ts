...
async function putDirectoryHandle(key: string, handle: FileSystemDirectoryHandle): Promise<void> {
...
async function getDirectoryHandle(key: string): Promise<FileSystemDirectoryHandle | undefined> {
...
export async function saveBambuStudioRootHandle(handle: FileSystemDirectoryHandle): Promise<void> {
  await putDirectoryHandle(KEY_STUDIO_ROOT, handle);
}

export async function loadBambuStudioRootHandle(): Promise<FileSystemDirectoryHandle | undefined> {
  return getDirectoryHandle(KEY_STUDIO_ROOT);
}

export async function saveUsersDirHandle(handle: FileSystemDirectoryHandle): Promise<void> {
  await putDirectoryHandle(KEY_USERS_DIR, handle);
}

export async function loadUsersDirHandle(): Promise<FileSystemDirectoryHandle | undefined> {
  return getDirectoryHandle(KEY_USERS_DIR);
}

export async function saveSystemProcessDirHandle(handle: FileSystemDirectoryHandle): Promise<void> {
  await putDirectoryHandle(KEY_SYSTEM_PROCESS, handle);
}

export async function loadSystemProcessDirHandle(): Promise<FileSystemDirectoryHandle | undefined> {
