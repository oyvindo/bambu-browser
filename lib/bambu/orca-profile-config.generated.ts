...
> = {
  ...
  activate_air_filtration_on_completion: {
    type: "coBools",
    tooltip:
      "Enable this to override the fan speed set in custom G-code after print completion.",
  },
  ...
  avoid_extrusion_cali_region: {
    ...
    tooltip:
      "If enabled, Arrange will avoid extrusion calibrate region when placing objects.",
  },
  bbl_calib_mark_logo: {
    type: "coBool",
  ...
  e_position: {
    ...
    tooltip:
      "Current position of the extruder axis. Only used with absolute extruder addressing.",
  },
  e_restart_extra: {
    type: "coFloats",
  ...
  elefant_foot_compensation: {
    ...
    category: "Quality",
    tooltip:
      "Shrinks the first layer on build plate to compensate for elephant foot effect.",
    sidetext: "mm",
    advanced: true,
  },
  ...
  enable_pressure_advance: {
    ...
    tooltip:
      "Enable pressure advance, auto calibration result will be overwritten once enabled.",
  },
  enable_prime_tower: {
    type: "coBool",
    label: "Enable",
  ...
  extruded_volume: {
    ...
    tooltip:
      "Total filament volume extruded per extruder during the entire print.",
  },
  ...
  filament_change_extrusion_role_gcode: {
    ...
    tooltip:
      "This G-code is inserted when the extrusion role is changed for the active filament.",
    advanced: true,
  },
  ...
  filament_flush_volumetric_speed: {
    ...
    tooltip:
      "Volumetric speed when flushing filament. 0 indicates the max volumetric speed.",
    sidetext: "mm³/s",
    advanced: true,
  },
  filament_ids: {
  ...
  filament_tower_interface_purge_volume: {
    ...
    tooltip:
      "Purge length for prime tower interface layer (where different materials meet).",
    sidetext: "mm",
    advanced: true,
  },
  filament_tower_ironing_area: {
    ...
    tooltip:
      "Ironing area for prime tower interface layer (where different materials meet).",
    sidetext: "mm²",
    advanced: true,
  },
  filament_type: {
  ...
  layer_num: {
    ...
    label: "Layer number",
    tooltip:
      "Index of the current layer. One-based (i.e. first layer is number 1).",
  },
  layer_z: {
    type: "coFloat",
    label: "Layer Z",
  ...
  no_check: {
    ...
    label: "No check",
    tooltip:
      "Do not run any validity checks, such as G-code path conflicts check.",
  },
  normal_print_time: {
    type: "coString",
  ...
  num_extruders: {
    ...
    tooltip:
      "Total number of extruders, regardless of whether they are used in the current print.",
  },
  num_instances: {
    type: "coInt",
    label: "Number of instances",
    tooltip:
      "Total number of object instances in the print, summed over all objects.",
  },
  num_objects: {
    type: "coInt",
  ...
  parallel_printheads_count: {
    ...
    tooltip:
      "Set the number of parallel printheads for machines like OrangeStorm Giga printer.",
    advanced: true,
  },
  ...
  printer_agent: {
    ...
    label: "Printer Agent",
    tooltip:
      "Select the network agent implementation for printer communication.",
    advanced: true,
  },
  printer_extruder_id: {
    type: "coInts",
  ...
  printing_filament_types: {
    ...
    tooltip:
      "Comma-separated list of all filament types used during the print.",
  },
  ...
  skip_modified_gcodes: {
    ...
    tooltip:
      "Skip the modified G-code in 3MF from printer or filament presets.",
  },
  skip_objects: {
    type: "coInts",
    label: "Skip Objects",
  ...
  support_parallel_printheads: {
    ...
    tooltip:
      "Enable printer settings for machines that can use multiple printheads in parallel.",
    advanced: true,
  },
  ...
  zhop: {
    ...
    label: "Current Z-hop",
    tooltip:
      "Contains Z-hop present at the beginning of the custom G-code block.",
  },
};
