...
import { fileExistsUnderRoot, normalizeRelativePath, readJsonUnderRoot } from './fs-path-utils';
...
export function createStudioRootAccess(root: FileSystemDirectoryHandle): ProfileFsAccess {
  return {
 ...
 */
export function createSplitUsersAccess(params: SplitUsersAccessParams): ProfileFsAccess {
