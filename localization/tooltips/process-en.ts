...
export const PROCESS_TOOLTIPS_EN: Readonly<Partial<Record<string, ProcessTooltipEntry>>> = {
  layer_height: {
    impact:
  ...
  detect_thin_wall: {
    ...
    related: 'wall_generator and perimeter line widths change when thin-wall handling kicks in.',
  },
  ...
  enable_arc_fitting: {
    ...
    related: 'Enable it only when the printer firmware supports G2/G3 arc commands correctly.',
  },
  bridge_flow: {
    impact:
  ...
  infill_wall_overlap: {
    ...
    related: 'sparse_infill_density and line widths change how much overlap is “just right.”',
  },
  initial_layer_speed: {
    impact:
  ...
  inner_wall_speed: {
    ...
    related: 'wall_loops multiply how long perimeters take; balance with outer_wall_speed.',
  },
  sparse_infill_speed: {
    impact:
    ...
    related: 'sparse_infill_density and default_acceleration limit how aggressive this can be.',
  },
  travel_speed: {
    impact:
  ...
  default_acceleration: {
    ...
    related: 'All print speeds (walls, infill) feel this limit—especially on small segments.',
  },
  travel_acceleration: {
    impact:
  ...
  support_on_build_plate_only: {
    ...
    related: 'support_type and part orientation determine whether build-plate-only is viable.',
  },
  ...
  support_bottom_z_distance: {
    impact: 'Sets the vertical gap between a bottom support interface and the object beneath it.',
    related:
  ...
  brim_object_gap: {
    ...
    related: 'brim_width sets the outer extent; together they define brim usability.',
  },
  skirt_loops: {
    impact:
  ...
  skirt_height: {
    ...
    related: 'Primarily interacts with skirt_loops for startup purging behavior.',
  },
  enable_prime_tower: {
    impact:
