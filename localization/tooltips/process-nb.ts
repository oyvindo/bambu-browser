...
export const PROCESS_TOOLTIPS_NB: Readonly<Partial<Record<string, ProcessTooltipEntry>>> = {
  layer_height: {
    impact:
  ...
  seam_position: {
    ...
    related: 'outer_wall_speed og retraksjon (andre steder i profilen) påvirker også sømmen.',
  },
  detect_thin_wall: {
    impact:
    ...
    related: 'wall_generator og omkrets-linjebredder avgjør når tynn-vegg-logikk aktiveres.',
  },
  ...
  enable_arc_fitting: {
    ...
    related: 'Aktiver bare når skriverens firmware støtter G2/G3-buekommandoer korrekt.',
  },
  bridge_flow: {
    impact:
  ...
  bottom_shell_layers: {
    impact: 'Angir antall solide lag i bunnskallet, inkludert laget på selve bunnflaten.',
    related:
  ...
  infill_wall_overlap: {
    ...
    related: 'sparse_infill_density og linjebredder endrer hva som er «akkurat passe» overlap.',
  },
  initial_layer_speed: {
    impact:
  ...
  inner_wall_speed: {
    ...
    related: 'wall_loops multipliserer omkretstid; balanser med outer_wall_speed.',
  },
  sparse_infill_speed: {
    impact:
  ...
  travel_acceleration: {
    ...
    related: 'Samspiller med travel_speed for hvor aggressivt hodet flyttes mellom ekstruderinger.',
  },
  enable_support: {
    impact:
    ...
    related: 'support_type, support_style og terskel/Z-avstand gjelder bare når dette er på.',
  },
  support_type: {
    impact:
  ...
  support_on_build_plate_only: {
    ...
    related: 'support_type og delorientering avgjør om kun-plate er realistisk.',
  },
  ...
  support_bottom_z_distance: {
    impact: 'Angir den vertikale avstanden mellom et nedre støttegrensesjikt og objektet under.',
    related:
  ...
  brim_width: {
    ...
    related: 'brim_type velger om brim brukes; brim_object_gap påvirker løsning fra skallet.',
  },
  brim_object_gap: {
    impact:
    ...
    related: 'brim_width setter yttergrensen; sammen definerer de brukervennligheten.',
  },
  skirt_loops: {
    impact:
