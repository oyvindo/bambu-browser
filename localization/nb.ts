...
export const messagesNb = {
  meta: {
    ...
    description: 'Utforsk arv i prosess- og filamentprofiler fra Bambu Studio og OrcaSlicer',
  },
  header: {
    title: 'Profilutforsker for slicere',
    subtitle: 'Profiler leses fra denne maskinen gjennom det lokale API-et. Ingenting lastes opp.',
    apiPrefix: 'API:',
    sourceLabel: 'Kilde:',
    layoutLabel: 'layout:',
  ...
  dataSource: {
    ...
    macPathTip: 'Velg Gå → Gå til mappe… (⇧⌘G) i Finder. Library-mappen er vanligvis skjult.',
    windowsPathTip:
  ...
  errors: {
    ...
    cannotReachApi: 'Får ikke kontakt med det lokale API-et. Kjør: node server.js (se terminal).',
  ...
  sidebar: {
    ...
    loading: 'Laster…',
    emptyProfiles: 'Ingen JSON-profiler funnet. Sjekk stien til valgt slicer og kontomappene.',
  ...
  treeGrid: {
    ...
    customFileCopied: 'Den egendefinerte filen {filename} er kopiert til utklippstavlen',
  ...
  profileEditor: {
    ...
    confirmDiscardBody: 'Endringene er ikke lagret. Denne handlingen kan ikke angres.',
    ...
    savedDescription: 'Leaf-filen ble erstattet og profilen ble lastet på nytt.',
